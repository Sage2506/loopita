...
export class StatsSummary extends Component {
  ...
  componentDidMount = () => {
    ...
    // store in reducer const servicePlan = getSelectedPlan() // selected month plan if one
    // store in reducer const dailyServiceConfig = getSelectedDates(); // configurated daily plan if one
